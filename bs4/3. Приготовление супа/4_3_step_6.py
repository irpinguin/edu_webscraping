"""
Написать код, который будет обрабатывать HTML-структуру, состоящую из различных тегов,
...
def main():
    ...
    # print(img_tags[0].get('alt'))

    # Извлекаем значения атрибута alt и суммируем их
    total_sum = sum(int(item.get('alt')) for item in img_tags)
